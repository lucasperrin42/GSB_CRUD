...
if($_POST){
    ...
    && isset($_POST['nombre']) && !empty($_POST['nombre'])){
        ...
        $query->bindValue(':idEtat', $produit, PDO::PARAM_STR);
...
if(isset($_GET['idVisiteur'.'mois']) && !empty($_GET['id'.'mois'])){
    require_once('connect.php');

    // On nettoie l'id envoyé
    $id = strip_tags($_GET['idVisiteur'.'mois']);

    $sql = 'SELECT * FROM `FicheFrais` WHERE `idVisiteur` and `mois` = :id;';
...
<head>
    ...
    <title>Modifier une fiche frais</title>
